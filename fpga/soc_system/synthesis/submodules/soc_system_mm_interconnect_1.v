...
module soc_system_mm_interconnect_1 (
		...
		output wire [1:0]  hex_0_pio_s1_address,                                   //                                     hex_0_pio_s1.address
		output wire        hex_0_pio_s1_write,                                     //                                                 .write
		input  wire [31:0] hex_0_pio_s1_readdata,                                  //                                                 .readdata
		output wire [31:0] hex_0_pio_s1_writedata,                                 //                                                 .writedata
		output wire        hex_0_pio_s1_chipselect,                                //                                                 .chipselect
	...
	wire   [31:0] hex_0_pio_s1_agent_m0_readdata;                                             // hex_0_pio_s1_translator:uav_readdata -> hex_0_pio_s1_agent:m0_readdata
	wire          hex_0_pio_s1_agent_m0_waitrequest;                                          // hex_0_pio_s1_translator:uav_waitrequest -> hex_0_pio_s1_agent:m0_waitrequest
	wire          hex_0_pio_s1_agent_m0_debugaccess;                                          // hex_0_pio_s1_agent:m0_debugaccess -> hex_0_pio_s1_translator:uav_debugaccess
	wire   [31:0] hex_0_pio_s1_agent_m0_address;                                              // hex_0_pio_s1_agent:m0_address -> hex_0_pio_s1_translator:uav_address
	wire    [3:0] hex_0_pio_s1_agent_m0_byteenable;                                           // hex_0_pio_s1_agent:m0_byteenable -> hex_0_pio_s1_translator:uav_byteenable
	wire          hex_0_pio_s1_agent_m0_read;                                                 // hex_0_pio_s1_agent:m0_read -> hex_0_pio_s1_translator:uav_read
	wire          hex_0_pio_s1_agent_m0_readdatavalid;                                        // hex_0_pio_s1_translator:uav_readdatavalid -> hex_0_pio_s1_agent:m0_readdatavalid
	wire          hex_0_pio_s1_agent_m0_lock;                                                 // hex_0_pio_s1_agent:m0_lock -> hex_0_pio_s1_translator:uav_lock
	wire   [31:0] hex_0_pio_s1_agent_m0_writedata;                                            // hex_0_pio_s1_agent:m0_writedata -> hex_0_pio_s1_translator:uav_writedata
	wire          hex_0_pio_s1_agent_m0_write;                                                // hex_0_pio_s1_agent:m0_write -> hex_0_pio_s1_translator:uav_write
	wire    [2:0] hex_0_pio_s1_agent_m0_burstcount;                                           // hex_0_pio_s1_agent:m0_burstcount -> hex_0_pio_s1_translator:uav_burstcount
	wire          hex_0_pio_s1_agent_rf_source_valid;                                         // hex_0_pio_s1_agent:rf_source_valid -> hex_0_pio_s1_agent_rsp_fifo:in_valid
	wire  [106:0] hex_0_pio_s1_agent_rf_source_data;                                          // hex_0_pio_s1_agent:rf_source_data -> hex_0_pio_s1_agent_rsp_fifo:in_data
	wire          hex_0_pio_s1_agent_rf_source_ready;                                         // hex_0_pio_s1_agent_rsp_fifo:in_ready -> hex_0_pio_s1_agent:rf_source_ready
	wire          hex_0_pio_s1_agent_rf_source_startofpacket;                                 // hex_0_pio_s1_agent:rf_source_startofpacket -> hex_0_pio_s1_agent_rsp_fifo:in_startofpacket
	wire          hex_0_pio_s1_agent_rf_source_endofpacket;                                   // hex_0_pio_s1_agent:rf_source_endofpacket -> hex_0_pio_s1_agent_rsp_fifo:in_endofpacket
	wire          hex_0_pio_s1_agent_rsp_fifo_out_valid;                                      // hex_0_pio_s1_agent_rsp_fifo:out_valid -> hex_0_pio_s1_agent:rf_sink_valid
	wire  [106:0] hex_0_pio_s1_agent_rsp_fifo_out_data;                                       // hex_0_pio_s1_agent_rsp_fifo:out_data -> hex_0_pio_s1_agent:rf_sink_data
	wire          hex_0_pio_s1_agent_rsp_fifo_out_ready;                                      // hex_0_pio_s1_agent:rf_sink_ready -> hex_0_pio_s1_agent_rsp_fifo:out_ready
	wire          hex_0_pio_s1_agent_rsp_fifo_out_startofpacket;                              // hex_0_pio_s1_agent_rsp_fifo:out_startofpacket -> hex_0_pio_s1_agent:rf_sink_startofpacket
	wire          hex_0_pio_s1_agent_rsp_fifo_out_endofpacket;                                // hex_0_pio_s1_agent_rsp_fifo:out_endofpacket -> hex_0_pio_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_006_src_valid;                                                      // cmd_mux_006:src_valid -> hex_0_pio_s1_agent:cp_valid
	wire  [105:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> hex_0_pio_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                      // hex_0_pio_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                    // cmd_mux_006:src_channel -> hex_0_pio_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                              // cmd_mux_006:src_startofpacket -> hex_0_pio_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                // cmd_mux_006:src_endofpacket -> hex_0_pio_s1_agent:cp_endofpacket
	...
	wire          hex_0_pio_s1_agent_rp_valid;                                                // hex_0_pio_s1_agent:rp_valid -> router_008:sink_valid
	wire  [105:0] hex_0_pio_s1_agent_rp_data;                                                 // hex_0_pio_s1_agent:rp_data -> router_008:sink_data
	wire          hex_0_pio_s1_agent_rp_ready;                                                // router_008:sink_ready -> hex_0_pio_s1_agent:rp_ready
	wire          hex_0_pio_s1_agent_rp_startofpacket;                                        // hex_0_pio_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          hex_0_pio_s1_agent_rp_endofpacket;                                          // hex_0_pio_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          hex_0_pio_s1_agent_rdata_fifo_src_valid;                                    // hex_0_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] hex_0_pio_s1_agent_rdata_fifo_src_data;                                     // hex_0_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          hex_0_pio_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_006:in_0_ready -> hex_0_pio_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                          // avalon_st_adapter_006:out_0_valid -> hex_0_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                           // avalon_st_adapter_006:out_0_data -> hex_0_pio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                          // hex_0_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                          // avalon_st_adapter_006:out_0_error -> hex_0_pio_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) hex_0_pio_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (hex_0_pio_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (hex_0_pio_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (hex_0_pio_s1_agent_m0_read),                    //                         .read
		.uav_write              (hex_0_pio_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (hex_0_pio_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (hex_0_pio_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (hex_0_pio_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (hex_0_pio_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (hex_0_pio_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (hex_0_pio_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (hex_0_pio_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (hex_0_pio_s1_address),                          //      avalon_anti_slave_0.address
		.av_write               (hex_0_pio_s1_write),                            //                         .write
		.av_readdata            (hex_0_pio_s1_readdata),                         //                         .readdata
		.av_writedata           (hex_0_pio_s1_writedata),                        //                         .writedata
		.av_chipselect          (hex_0_pio_s1_chipselect),                       //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (hex_0_pio_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (hex_0_pio_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (hex_0_pio_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (hex_0_pio_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (hex_0_pio_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (hex_0_pio_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (hex_0_pio_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (hex_0_pio_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (hex_0_pio_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (hex_0_pio_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (hex_0_pio_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (hex_0_pio_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (hex_0_pio_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (hex_0_pio_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (hex_0_pio_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (hex_0_pio_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (hex_0_pio_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (hex_0_pio_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (hex_0_pio_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (hex_0_pio_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (hex_0_pio_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (hex_0_pio_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (hex_0_pio_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (hex_0_pio_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (hex_0_pio_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (hex_0_pio_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),             //                .error
		.rdata_fifo_src_ready    (hex_0_pio_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (hex_0_pio_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (hex_0_pio_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) hex_0_pio_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (hex_0_pio_s1_agent_rf_source_data),             //        in.data
		.in_valid          (hex_0_pio_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (hex_0_pio_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (hex_0_pio_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (hex_0_pio_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (hex_0_pio_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (hex_0_pio_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (hex_0_pio_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (hex_0_pio_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (hex_0_pio_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	soc_system_mm_interconnect_1_router_002 router_008 (
		.sink_ready         (hex_0_pio_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (hex_0_pio_s1_agent_rp_valid),                   //          .valid
		.sink_data          (hex_0_pio_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (hex_0_pio_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (hex_0_pio_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (hex_0_pio_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (hex_0_pio_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (hex_0_pio_s1_agent_rdata_fifo_src_ready),       //         .ready
